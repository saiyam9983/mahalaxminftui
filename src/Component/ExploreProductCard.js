        ...
        <div className="  rounded-xl py-6  mb-6  flex 3xl:justify-end justify-center items-center space-x-4 mx-2  hover:scale-105 duration-500" >
            ...
            {props.data.id === 2 ?(
              ...
              <div className="w-full flex justify-center items-center absolute bottom-[250px] left-[-2px]" >
                ...
                <span className="text-white font-bold px-1">{props.data.time}</span>
                </div>
              </div>
              )
              }
              <div className="flex justify-between items-center mt-5">
                ...
                <div className="">
                  <button className={toggle === 1 ? "p-1 px-5 font-bold text-white  text-md rounded-xl bg-gray-800  border-none " : "p-1 px-5  font-bold text-white  text-md rounded-xl boxbgColor "}>
                    BSC
                  </button>
                </div>
              </div>
